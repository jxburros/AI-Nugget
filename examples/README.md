...
| `integrations/` | CI-verified host starters: Express, Next.js App Router, Cloudflare Workers, local Ollama, and an ESM/CJS packaging check — see `integrations/README.md` |
