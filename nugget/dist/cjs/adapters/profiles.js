...
exports.PROVIDER_PROFILES = void 0;
...
function profileFor(provider, baseUrl) {
    return exports.PROVIDER_PROFILES[provider] ?? {
        ...exports.PROVIDER_PROFILES['openai-compat'],
        defaultBaseUrl: baseUrl,
    };
}
function applyAuth(profile, apiKey, headers) {
