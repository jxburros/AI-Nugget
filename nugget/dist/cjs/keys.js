...
exports.envKeySource = envKeySource;
exports.literalKeySource = literalKeySource;
exports.memoryKeySource = memoryKeySource;
exports.chainKeySources = chainKeySources;
const util_js_1 = require("./util.js");
function parseKeyRef(value) {
...
function envKeySource(env = (0, util_js_1.globalEnv)()) {
    return {
        async resolve(ref) {
            if (ref.kind === 'none')
...
function memoryKeySource(values) {
    return {
        async resolve(ref) {
            if (ref.kind === 'none')
                return { ok: true, apiKey: null };
...
function chainKeySources(...sources) {
    return {
        async resolve(ref) {
            let missing = false;
